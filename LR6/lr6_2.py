...
def main():
    ...
    for height in test_data:
        res_recursive.append(benchmark(build_tree_recursive, height , root, repeat=height))
        res_iterative.append(benchmark(build_tree_iteractive, height , root, repeat=height))
