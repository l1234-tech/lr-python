...
class TestMySolution(unittest.TestCase):
    def test_simple(self):
        ...
        self.assertEqual(gen_bin_tree(1, 18.1),"Некорректное значение root (должно быть натуральное число или 0)")
        # строим бинарное дерево, где root нецелое число

        self.assertEqual(gen_bin_tree(1, -10), "Некорректное значение root (должно быть натуральное число или 0)")
