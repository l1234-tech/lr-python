...
class TestMySolution(unittest.TestCase):
    def test_simple(self):
        self.assertEqual(binary_search(2, list(range(1,100)), 0), [2,7])
        # угадывание числа 2 из диапозона 1 - 100

        self.assertEqual(binary_search(2, list(range(0,50)), 0), [2,4])
        # угадывание числа 2 из диапозона 0 - 50

        self.assertEqual(binary_search(2, list(range(1, 10000)), 0), [2, 12])
        # угадывание числа 2 из диапозона 1 - 10000

        self.assertEqual(binary_search(-67, list(range(-100, -50)), 0), [-67, 4])
        # угадывание числа -67 из диапозона -100 - (-50)

        self.assertEqual(binary_search(2, list(range(-10, 10)), 0), [2, 4])
        # угадывание числа 2 из диапозона -10 - 10

        self.assertEqual(binary_search(2, list(range(3, 100)), 0), [None, 6])
